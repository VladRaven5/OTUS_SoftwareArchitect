...
namespace TasksService
{
    public static class CacheSettings
    {
        ...
        public static readonly TimeSpan TaskIdCacheLifetime = TimeSpan.FromMinutes(1);  

        public static readonly string UserTasksCacheKeyPattern = "user-tasks-{0}"; //0 - user id
        public static readonly TimeSpan UserTasksCacheLifetime = TimeSpan.FromMinutes(1);

        private static readonly string _tasksFilterCacheKeyPattern = "tasks-filter-{0}";
        public static readonly TimeSpan TasksFilterCacheLifetime = TimeSpan.FromMinutes(1);
