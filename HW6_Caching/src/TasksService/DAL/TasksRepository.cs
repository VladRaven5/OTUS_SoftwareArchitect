...
namespace TasksService
{
    public class TasksRepository : BaseDapperRepository
    {
        ...
        public async Task<IEnumerable<TaskAggregate>> FilterTasksAsync(FilterTaskArgs args)
        {
            ...
            // whereStatement = AddContainsStringStatement(whereStatement, args.LabelsIds, "lb.id");
            // whereStatement = AddContainsStringStatement(whereStatement, args.UsersIds, "u.id");
